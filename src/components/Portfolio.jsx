    ...
    const portfolios = [
        {
            id: 1,
            src: chatroom,
            demoLink: 'http://13.60.95.206:8000/',  
            codeLink: 'https://github.com/santhosh830/Teamchatroom',
        },
        {
            id: 2,
            src: cloudservices,
            demoLink: 'https://webcloudservices.netlify.app/',
            codeLink: 'https://github.com/santhosh830/yt-cloud-web-services-website',
        },
        {
            id: 3,
            src: djangovideo,
            demoLink: 'http://51.20.67.64:8000/',
            codeLink: 'https://github.com/santhosh830/Videochatroom',
        },
        {
            id: 4,
            src: ecommerce,
            demoLink: 'https://e-commercecloths.netlify.app/',
            codeLink: 'https://github.com/santhosh830/E-Commerce',
        },
        {
            id: 5,
            src: weather,
            demoLink: 'https://weatherupdateapplication.netlify.app/',
            codeLink: 'https://github.com/santhosh830/Weatherapplication',
        },
    ];

    return (
        <div name='portfolio' className='bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen overflow-x-hidden'>
